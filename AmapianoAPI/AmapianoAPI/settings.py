"""
Django settings for AmapianoAPI project.
...
SECRET_KEY = 'django-insecure-=fo)$su0p-g=vut+hgpqpqz3wmll+z_qq^r%kl$s8()ev7@b83'
...
WSGI_APPLICATION = 'AmapianoAPI.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',  # This should match the name specified in your Azure PostgreSQL setup
